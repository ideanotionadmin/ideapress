...
(function () {
    ...
    function ready(element, options) {
        ...
        document.getElementById("home").addEventListener("click", function () { var nav = WinJS.Navigation; ideaPress.navBack(nav, nav.history.backStack.length);/*nav.back(nav.history.backStack.length);*/ }, false);
