...
MakeCert /n "%1" /r /h 0 /eku "1.3.6.1.5.5.7.3.3,1.3.6.1.4.1.311.10.3.13" /e 01/01/2020 /sv c:\builds\key\AppFactory.pvk c:\builds\key\AppFactory.cer
...
copy c:\builds\key\IdeaPress.pfx C:\builds\Template\af.2.0.0\IdeaPress\IdeaPress.pfx